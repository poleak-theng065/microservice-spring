    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http,
        ...
        SecurityWebFilterChain chain = http
                ...
                .authorizeExchange(exchange -> exchange
                        ...
                        .pathMatchers(HttpMethod.GET, "/api/user").hasAnyRole("ROLE_USER", "ROLE_ADMIN")
                        .pathMatchers(HttpMethod.POST, "/api/user").hasRole("ROLE_ADMIN")
                        .pathMatchers(HttpMethod.PUT, "/api/user/{userID}").hasRole("ROLE_ADMIN")
                        .pathMatchers(HttpMethod.GET, "/api/users/verification/{userID}").hasRole("ROLE_ADMIN")
                        .pathMatchers(HttpMethod.DELETE, "/api/user/{userID}").hasRole("ROLE_ADMIN")
